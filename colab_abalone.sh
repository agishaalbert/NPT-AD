...
python run.py --n_runs 20 \
    ...
    --exp_n_hidden_features 1 --exp_n_hidden_features 2 --exp_n_hidden_features 3 --exp_n_hidden_features 4 \
    ...
    --model_init_params 0.05 --model_init_params 0 \
